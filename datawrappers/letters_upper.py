...
def __create_letters_upper_indices():
    ...
    np.save(path_to_data + '/letters_upper_indices.npy', np.array(indices, dtype=object))
...
def __create_letters_upper_dev_indices():
    ...
    np.save(path_to_data + '/letters_upper_dev_indices.npy', np.array(indices, dtype=object))
