...
def __create_letters_lower_indices():
    ...
    np.save(path_to_data + '/letters_lower_indices.npy', np.array(indices, dtype=object))
...
def __create_letters_lower_dev_indices():
    ...
    np.save(path_to_data + '/letters_lower_dev_indices.npy', np.array(indices, dtype=object))
