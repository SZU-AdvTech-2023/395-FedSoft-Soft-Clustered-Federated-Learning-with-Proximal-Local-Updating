...
from models import Cifar10CnnModel,Digit5CNN,MnistMLP
...
def run_classification_exp(exp_id):
    ...
    client_vec, test_ds_vec, preparation_dict = create_clients_mnist_and_mnist_rotation_90(client_solver)
