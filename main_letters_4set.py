...
from solvers import ServerSolver, Cifar10CNNClientSolver,LettersCNNClientSolver
...
def run_classification_exp(exp_id):
    ...
    client_solver = LettersCNNClientSolver()
    create_data_start_time = time.time()
    client_vec, test_ds_vec, preparation_dict = create_clients_letters_rotation_4set(client_solver)
...
def main():
    exp_id = 'experiment_6_letters_4set'
    init_exp(exp_id)
